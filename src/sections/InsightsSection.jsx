    ...
    <section className="section blog-section section-theme-light" id="blog">
      <div className="container">
        ...
        <div className="insights-editorial-grid">
          ...
          <Reveal delay={0.1}>
            <Link to="/blog/why-your-website-isnt-converting" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
          ...
          <div className="insights-supporting-col">
            <Reveal delay={0.2}>
              <Link to="/blog/how-companies-save-20-hours-with-ai" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
            ...
            <Reveal delay={0.3}>
              <Link to="/blog/building-a-high-trust-brand-identity" style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                <div className="insight-secondary-card">
                  <div className="insight-meta-flex">
